...
public class CreateJava {
    ...
    public void test1() {
        ...
        for(String tableName:rsList) {
            ...
            try {
                ...
                File entity = new File("DataSource/entity",StringUtil.uplowerFirst(tableName)+".java");
    ...
    public static String getPackage() throws Exception {
        ...
        Document dataSourceDoc = PlugClass.initDataSource();
        Element e = dataSourceDoc.getElementsByTag("package").first();
        
        //设置打包名
        pac = pac.append("package "+e.html()+";"+PlugClass.NEW_LINE+PlugClass.NEW_LINE);
        return pac.toString();
    }
